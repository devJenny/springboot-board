...
public class BoardService {
    ...
    public void save(BoardDTO boardDTO) throws IOException {
        ...
        if (boardDTO.getBoardFile().isEmpty()) {
            ...
            /*
                1. DTO에 담긴 파일을 꺼냄
                2. 파일의 이름 가져옴
                3. 서버 저장용 이름을 만듦 (사진.jpg -> 123654789_내사진.jpg)
                4. 저장 경로 설정
                5. 해당 경로에 파일 저장
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        Page<BoardEntity> boardEntities =
                boardRepository.findAll(PageRequest.of(page, pageLimit, Sort.by(Sort.Direction.DESC, "id"))); // properties는 entity에 있는 기준
